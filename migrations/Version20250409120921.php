 ...
 */
final class Version20250409120921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD product_id INT NOT NULL, ADD created_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders DROP product_id, DROP created_at');
    }
}
