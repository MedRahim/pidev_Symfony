 ...
 */
final class Version20250430212220 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_post ADD title VARCHAR(255) NOT NULL, ADD content LONGTEXT NOT NULL');
    }
}
